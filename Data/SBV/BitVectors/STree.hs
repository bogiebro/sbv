...
readSTree :: (Num i, Bits i, SymWord i, SymWord e, SIntegral i) => STree i e -> SBV i -> SBV e
...
writeSTree :: (Mergeable (SBV e), SIntegral i, Num i, Bits i, SymWord i, SymWord e) => STree i e -> SBV i -> SBV e -> STree i e
